 ...
 * jQuery EasyUI treegrid widgets. These lock down the response SHAPE and the
 * tree-assembly LOGIC that a future EasyUI -> Laravel rewrite must preserve.
 *
...
final class EasyUiTreeBuilderTest extends IntegrationTestCase
{
    ...
    public function test_status_1_nests_frameworks_by_parent_via_makeTree(): void
    {
        ...
        // Envelope: EasyUI treegrid expects {totalCount, rows}.
